...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1615578388.8195646
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1615578388.8195646
...
ASM_FLAGS += -include
ASM_FLAGS += /filer/workspace_data/exports/9/9d8f117893bde9560bfa36e173471586/mbed_blinky/mbed_config.h
ASM_FLAGS += -c
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -Wall
